...
CMD_HELP.update(
    ...
    \n  • **Função : **Creates a image meme with give text at specific locations and sends\
    \n\n  • **Syntax : **`.mms toptext ; bottomtext`\
    \n  • **Função : **Creates a sticker meme with give text at specific locations and sends\
    \n\n  • **Syntax : **`.ascii`\
    \n  • **Função : **reply to media file to get ascii image of that media\
    \n\n  • **Syntax : **`.invert`\
    \n  • **Função : **Inverts the colors in media file\
    \n\n  • **Syntax : **`.solarize`\
    \n  • **Função : **Watch sun buring ur media file\
    \n\n  • **Syntax : **`.mirror`\
    \n  • **Função : **shows you the reflection of the media file\
    \n\n  • **Syntax : **`.flip`\
    \n  • **Função : **shows you the upside down image of the given media file\
    \n\n  • **Syntax : **`.gray`\
    \n  • **Função : **makes your media file to black and white\
    \n\n  • **Syntax : **`.zoom` or `.zoom range`\
    \n  • **Função : **zooms your media file\
    \n\n  • **Syntax : **`.frame` or `.frame range` or `.frame range ; fill`\
    \n  • **Função : **make a frame for your media file\
