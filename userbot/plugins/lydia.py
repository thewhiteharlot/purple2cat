...
CMD_HELP.update(
    ...
    \n**Função : **your bot will auto reply to the tagged user until you stops it by `.remcf`\
    \n\n**Syntax : **`.reai` reply to the user\
    \n**Função : **disables the lydia\
    \n\n**Syntax : **`.liai`\
    \n**Função : ** to list the users to whom you enabled ai(lydia)\
